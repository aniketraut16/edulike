...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  // "Limit theme version": Only use light theme styles, remove all dark: classes and dark theme logic.
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full text-neutral-800">
