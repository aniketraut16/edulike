...
export default function Hero() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-[160vh] pt-[15vh] sm:pt-[20vh] bg-gradient-to-b from-white to-slate-50"
            style={{
                paddingLeft: padding,
        ...
        >
            ...
            >
                <div className="absolute inset-0 flex flex-col items-center justify-start pt-[10vh] sm:pt-[20vh] text-center px-4">
                    <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold text-white mb-3 sm:mb-5 max-w-3xl px-2">
                        Discover Your Next<br />Learning Adventure
                    </h1>
                    <p className="text-base sm:text-lg md:text-xl text-white mb-6 sm:mb-8 max-w-xl px-4">
                        Enroll in courses. Expand your skills. Achieve your goals.
                    </p>
                    <button className="bg-white text-black hover:bg-opacity-90 px-5 sm:px-7 py-2 sm:py-2.5 rounded-full text-sm sm:text-base font-medium flex items-center">
                        Start Learning Now
